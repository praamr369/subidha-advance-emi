...
export const ADMIN_ROUTE_TREE: AdminRouteRegistryItem[] = [
  ...
  item("Vendors & Procurement", "Vendors", ROUTES.admin.vendors, "Vendor register and operations."),
  item("Vendors & Procurement", "Vendor Categories", ROUTES.admin.vendorsCategories, "Vendor category master."),
  ...
  item("Vendors & Procurement", "Purchase Returns", `${ROUTES.admin.billingReversals}?scope=purchase`, "Purchase return workflow."),
  item("Vendors & Procurement", "Vendor Ledger", ROUTES.admin.vendorsLedger, "Vendor payable ledger entries."),
  item("Vendors & Procurement", "Vendor Outstanding", ROUTES.admin.vendorsOutstanding, "Vendor payable outstanding summary."),
