...
export default function UnauthorizedPage() {
  return (
    <div className="public-app flex min-h-screen items-center justify-center p-4">
      <main className="auth-stage w-full max-w-3xl" aria-labelledby="unauthorized-title">
        <div className="auth-shell overflow-hidden p-7 sm:p-8">
          ...
          <h1 id="unauthorized-title" className="text-center text-2xl font-semibold text-slate-900">
            Access denied
          </h1>
          ...
          <div className="workspace-filter-bar relative z-[1] mx-auto mt-6 max-w-2xl rounded-2xl p-4 text-left">
