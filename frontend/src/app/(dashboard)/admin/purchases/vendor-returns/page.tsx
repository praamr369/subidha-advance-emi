...
export default function AdminVendorReturnsPage(){
  return (
    <ERPPageShell eyebrow="Purchases & Vendors"
      title="Vendor Returns" subtitle="Purchase return workflow is available from vendor-specific operations." breadcrumbs={[{label:"Admin",href:ROUTES.admin.dashboard},{label:"Purchases",href:ROUTES.admin.purchases},{label:"Vendor Returns"}]} statusBadge={{ label: "Admin Only", tone: "info" as const }}> 
