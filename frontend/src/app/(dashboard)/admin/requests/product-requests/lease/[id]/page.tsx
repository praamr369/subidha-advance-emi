                ...
                <div className="rounded-xl border border-border bg-muted/30 p-4">
                  <StepIndicator
                    steps={[
                      ...
                      { id: "pricing", label: "Set Lease & Tenure", description: "Configure terms" },
                ...
                {step === "review" || request.customer_id ? (
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <div className="grid gap-3 md:grid-cols-2">
                        ...
                        <div className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-3">
                          ...
                          <div className="mt-2 text-lg font-bold text-blue-900">{formatRupee(totalLeaseCost)}</div>
                        </div>
                      </div>
                    ...
                    <ApprovalConfirmDialog
                      ...
                      title={dialogMode === "approve" ? "Approve Lease Request?" : "Reject Lease Request?"}
                      description={
                        dialogMode === "approve"
                          ? `Confirm approval for ${request.product_name} lease. A lease subscription will be created for ${formatRupee(totalLeaseCost)}.`
                          : `Confirm rejection of ${request.product_name} lease request.${rejectReason ? " " + rejectReason : ""}`
                      }
