                  ...
                  <div className="overflow-hidden rounded-xl border border-border">
                    <div className="divide-y divide-border/70">
                      {report.income.map((row) => (
                        <div key={row.account_id} className="flex items-center justify-between gap-3 bg-card px-4 py-2.5 transition hover:bg-muted/30">
                          ...
                          <div className="shrink-0 text-sm font-semibold tabular-nums text-emerald-700">{accountingMoney(row.amount)}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                    ...
                    <div className="divide-y divide-border/70">
                      {report.expenses.map((row) => (
                        <div key={row.account_id} className="flex items-center justify-between gap-3 bg-card px-4 py-2.5 transition hover:bg-muted/30">
                          ...
                          <div className="shrink-0 text-sm font-semibold tabular-nums text-amber-700">{accountingMoney(row.amount)}</div>
                        </div>
                      ))}
                    </div>
                  </div>
