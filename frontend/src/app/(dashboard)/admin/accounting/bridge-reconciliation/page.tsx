...
export default function AccountingBridgeReconciliationPage() {
  ...
  async function handleSeedDefaults() {
    ...
    try {
      ...
      setNotice(`Supported mapping defaults seeded. Journals created: ${result.journal_entries_created}; document numbers allocated: ${result.document_sequences_allocated}.`);
