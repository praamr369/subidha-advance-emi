        ...
        <section className="rounded-2xl border border-border bg-card p-5 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-4xl text-sm leading-6 text-muted-foreground">Concrete candidates include Payment, ReceiptDocument, BillingInvoice, BillingCreditNote, DirectSaleReturn, BillingDebitNote, PurchaseBill, VendorPayment, StockLedger, Commission, CommissionPayoutBatch, and SalarySheet. Abstract readiness rows show “View source items” and cannot post. Posting creates accounting entries only; it does not edit stock ledger, inventory quantity, valuation, sale/delivery, purchase bill, vendor payment, commission, payout, payroll, staff, attendance, StaffAdvance, or payment records.</p>
            </div>
      ...
      <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-border bg-background p-5 shadow-xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">Source model: {preview.source.model}. Posting does not mutate payroll, staff, attendance, StaffAdvance, payment, commission, payout, inventory, purchase, or source financial fields.</p>
