              ...
              {subscriptionFilter ? (
                <div className="mb-4 flex flex-wrap items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center rounded-md border border-blue-200 bg-card px-3 py-1.5 text-xs font-medium text-blue-900 transition hover:bg-blue-100"
                  >
                    Clear Filter
                  </Link>
                </div>
