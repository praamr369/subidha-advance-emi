...
const MOVEMENT_TYPE_OPTIONS = [
  ...
  { value: "RENT_HANDOVER_OUT", label: "Rent Handover Out" },
  { value: "RENT_RETURN_IN", label: "Rent Return In" },
  { value: "LEASE_HANDOVER_OUT", label: "Lease Handover Out" },
  { value: "LEASE_RETURN_IN", label: "Lease Return In" },
