      ...
      <WorkspaceSection title="Accounting Mapping Panel" description={MAPPING_NOTE}>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          {[
            ...
            <label htmlFor="f-label-expectedtype-setmappingform-c-c-ke" key={key} className="text-sm">
          ...
          <textarea id="f-label-expectedtype-setmappingform-c-c-ke" className="rounded-xl border px-3 py-2 text-sm md:col-span-2" rows={3} placeholder="Notes" value={mappingForm.notes} onChange={(e) => setMappingForm((c) => ({ ...c, notes: e.target.value }))} />
        </div>
