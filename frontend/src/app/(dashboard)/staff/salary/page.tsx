        ...
        <div className="space-y-4">
          <section className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="mt-2 text-2xl font-semibold text-foreground">{formatRupee(data.base_salary)}</div>
            </div>
            <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            {data.latest_payslip ? (
              <div className="mt-4 flex flex-col gap-3 rounded-xl border border-border p-4 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <div className="mt-1 text-sm text-muted-foreground">Net: {formatRupee(data.latest_payslip.net_amount)} · Status: {data.latest_payslip.status}</div>
                </div>
