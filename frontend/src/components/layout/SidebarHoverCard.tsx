...
export default function SidebarHoverCard({
  ...
  return (
    <div
      ...
      className="absolute left-full top-0 z-50 ml-3 w-72 rounded-xl border border-[var(--sidebar-rail-border)] bg-[color-mix(in_oklab,var(--sidebar-surface)_88%,black_12%)] p-3 shadow-[0_22px_50px_-34px_rgba(15,23,42,0.62)]"
    >
