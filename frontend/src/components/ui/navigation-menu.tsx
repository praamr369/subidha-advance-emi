...
export function NavigationMenuLink({ className, ...props }: ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "inline-flex rounded-full px-3 py-2 text-sm font-medium transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400/40 data-[active]:bg-card data-[active]:text-foreground data-[active]:shadow-[0_12px_28px_-22px_rgba(15,23,42,0.78)]",
        className
      )}
      {...props}
    />
