...
function OtpDigitSlot(props: SlotProps) {
  return (
    <div
      className={cn(
        "relative flex h-12 w-10 items-center justify-center border-y border-r border-slate-300 bg-card text-base font-semibold tabular-nums text-foreground transition-all first:rounded-l-xl first:border-l last:rounded-r-xl",
        props.isActive &&
