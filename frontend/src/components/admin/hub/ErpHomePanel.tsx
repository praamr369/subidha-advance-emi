...
/**
 * ERP module launcher — live status signals across Sales, CRM, Billing,
 * Inventory, Finance, Delivery, Reports, and Setup. Extracted from /admin/erp so
 * it renders both on that route and as the "ERP Home" tab of the unified hub
 * (/admin/workbench).
 */
export default function ErpHomePanel() {
