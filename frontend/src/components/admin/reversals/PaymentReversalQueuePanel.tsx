...
/**
 * Approval queue for payment reversal / receipt void requests. Extracted from
 * /admin/payments/reversals so the same workflow renders both on that route and
 * as a tab in the unified Reversal Center (/admin/billing/reversals).
 */
export default function PaymentReversalQueuePanel() {
