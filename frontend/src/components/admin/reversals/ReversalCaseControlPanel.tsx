...
/**
 * Audited reversal/return case control + reconciliation. Extracted from
 * /admin/finance/reversal-control so the same workflow renders both on that route
 * and as a tab in the unified Reversal Center (/admin/billing/reversals).
 */
export default function ReversalCaseControlPanel() {
