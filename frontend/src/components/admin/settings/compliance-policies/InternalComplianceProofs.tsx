...
export function InternalComplianceProofs() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap gap-2">
        ...
        <Link href={ROUTES.admin.settingsCompliancePolicies} className="rounded-xl border border-border bg-background px-3 py-2 text-sm font-semibold text-foreground transition hover:bg-accent">
          Policy governance
        </Link>
      </div>
