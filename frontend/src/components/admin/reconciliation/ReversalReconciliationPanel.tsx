...
/**
 * Approval-style queue for unresolved reversal/refund/return links that must be
 * reconciled with explicit evidence. Extracted from
 * /admin/finance/reversal-reconciliation so it renders both on that route and as a
 * tab in the Reconciliation Center.
 */
export default function ReversalReconciliationPanel() {
