    ...
    <div className="rounded-2xl border border-red-200/90 bg-[linear-gradient(180deg,rgba(254,242,242,0.98),rgba(254,226,226,0.9))] p-4 shadow-[0_16px_36px_-28px_rgba(127,29,29,0.42)]">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          {onRetry ? (
            <button
              className="mt-3 inline-flex items-center gap-1.5 rounded-lg border border-red-300 bg-white/90 px-3 py-1.5 text-sm font-semibold text-red-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] transition hover:-translate-y-0.5 hover:bg-red-100"
              onClick={onRetry}
              type="button"
            >
