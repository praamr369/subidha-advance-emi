  ...
  return (
    <div className="rounded-[1.4rem] border border-red-200/90 bg-[linear-gradient(180deg,rgba(254,242,242,0.98),rgba(254,226,226,0.9))] p-4 shadow-[0_16px_36px_-28px_rgba(127,29,29,0.42)]">
      <div className="flex items-start gap-3">
        <div className="rounded-2xl border border-red-200/90 bg-[color-mix(in_oklab,var(--surface-card-elevated)_90%,white_10%)] p-2 text-red-700 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
