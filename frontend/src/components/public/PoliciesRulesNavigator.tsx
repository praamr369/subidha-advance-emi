...
export default async function PoliciesRulesNavigator() {
  const locale = await getPublicLocale();
  const dict = getPublicDictionary(locale);
    const ruleGroups = [
      {
        icon: BadgeCheck,
        title: dict.public.PoliciesRulesNavigator_prop1,
        description: dict.public.PoliciesRulesNavigator_prop2,
        href: ROUTES.public.luckyPlan,
        cta: "Read Lucky Plan",
      },
      {
        icon: PackageCheck,
        title: dict.public.PoliciesRulesNavigator_prop3,
        description: dict.public.PoliciesRulesNavigator_prop4,
        href: ROUTES.public.rent,
        cta: "Read rent rules",
      },
      {
        icon: ReceiptText,
        title: dict.public.PoliciesRulesNavigator_prop5,
        description: dict.public.PoliciesRulesNavigator_prop6,
        href: ROUTES.public.directSale,
        cta: "Read sale rules",
      },
      {
        icon: Truck,
        title: dict.public.PoliciesRulesNavigator_prop7,
        description: dict.public.PoliciesRulesNavigator_prop8,
        href: ROUTES.public.deliveryPolicy,
        cta: "Delivery policy",
      },
      {
        icon: ShieldCheck,
        title: dict.public.PoliciesRulesNavigator_prop9,
        description: dict.public.PoliciesRulesNavigator_prop10,
        href: ROUTES.public.paymentPolicy,
        cta: "Payment policy",
      },
      {
        icon: ClipboardCheck,
        title: dict.public.PoliciesRulesNavigator_prop11,
        description: dict.public.PoliciesRulesNavigator_prop12,
  ...
  return (
    <section className="public-surface p-6">
      <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">{dict.public.PoliciesRulesNavigator_text13}</div>
      <h2 className="mt-2 text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">{dict.public.PoliciesRulesNavigator_text14}</h2>
