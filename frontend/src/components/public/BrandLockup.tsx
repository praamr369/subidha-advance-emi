...
export default function BrandLockup({
  ...
  return (
    <div className={cn("flex min-w-0 items-center gap-3", className)}>
      <div className="relative flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-[1.15rem] border border-border bg-[linear-gradient(155deg,rgba(255,255,255,0.95),rgba(226,232,240,0.82))] text-foreground shadow-[0_18px_40px_-28px_rgba(15,23,42,0.72)]">
