...
export async function seedAndPublishPolicyGovernance(): Promise<PolicyGovernanceSeedResult> { return apiFetch<PolicyGovernanceSeedResult>("/admin/setup/seed-policy-governance/", { method: "POST" }); }
