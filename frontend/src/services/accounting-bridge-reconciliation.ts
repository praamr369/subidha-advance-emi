...
export type BridgeSourceModel = "Payment" | "ReceiptDocument" | "BillingInvoice" | string;
...
export type BridgePostingPreview = { candidate: AccountingBridgeReconciliationRow; candidate_id: string; source: { model: BridgeSourceModel; pk: number | string; display: string; reference_number?: string | null; date: string; amount: string; invoice_number?: string | null; invoice_type?: string | null; invoice_status?: string | null; taxable_amount?: string | null; tax_amount?: string | null }; journal_date: string; accounting_period?: AccountingBridgeReconciliationRow["accounting_period"]; journal_number_preview?: string | null; debit_lines: BridgePostingLine[]; credit_lines: BridgePostingLine[]; lines: BridgePostingLine[]; total_debit: string; total_credit: string; is_balanced: boolean; tax_lines?: BridgePostingLine[]; finance_account_line?: BridgeFinanceAccount | null; warnings: string[]; blockers: string[]; can_post: boolean; idempotency_key: string; safety_text: string };
