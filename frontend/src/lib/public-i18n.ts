...
export function getPublicDictionary(locale: PublicLocale) {
  const content = {
    en: {
      ...
      common: { home: "Home", contact: "Contact", products: "Products", luckyPlan: "Lucky Plan", howItWorks: "How it works", winners: "Winners", winnerHistory: "Winner history", apply: "Apply / Enquire" },
    ...
    hi: {
      ...
      common: { home: "होम", contact: "संपर्क", products: "प्रोडक्ट्स", luckyPlan: "लकी प्लान", howItWorks: "कैसे काम करता है", winners: "विजेताओं", winnerHistory: "विजेता इतिहास", apply: "आवेदन / पूछताछ" },
    ...
    bn: {
      ...
      common: { home: "হোম", contact: "যোগাযোগ", products: "পণ্য", luckyPlan: "লাকি প্ল্যান", howItWorks: "কীভাবে কাজ করে", winners: "বিজয়ীরা", winnerHistory: "বিজয়ীর ইতিহাস", apply: "আবেদন / জিজ্ঞাসা" },
