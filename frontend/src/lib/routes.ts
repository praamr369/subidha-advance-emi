export const ROUTES = {
  ...
  admin: {
    ...
    financeCommissionsTypoAlias: "/admin/finance/commisions",
    ...
    luckyDrawLegacy: "/admin/lucky-draw",
    luckyDrawLegacyHistory: "/admin/lucky-draw/history",
    ...
    customerAdvances: "/admin/customer-advances",
    reconciliationRuns: "/admin/reconciliation/runs",
    receiptsSample: "/admin/receipts/sample",
    vendorPurchaseReturns: "/admin/vendors/purchase-returns",
  },
