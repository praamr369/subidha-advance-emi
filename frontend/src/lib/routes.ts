export const ROUTES = {
  ...
  admin: {
    ...
    settingsBusinessSetupProfile: "/admin/settings/business",
    settingsBusinessSetupChecklist: "/admin/setup/readiness",
    settingsBusinessSetupDocumentNumbering: "/admin/settings/business-setup",
    settingsBusinessSetupPublicSite: "/admin/settings/business",
    settingsBusinessSetupDryRuns: "/admin/settings/business-setup",
    settingsBusinessSetupReset: "/admin/settings/business-setup",
