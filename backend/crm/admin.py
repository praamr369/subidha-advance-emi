...
class PartyMasterAdmin(UnfoldModelAdmin):
...
class PartyLinkAdmin(UnfoldModelAdmin):
...
class PartyInteractionAdmin(UnfoldModelAdmin):
...
class FollowUpTaskAdmin(UnfoldModelAdmin):
...
class CustomerInteractionAdmin(UnfoldModelAdmin):
