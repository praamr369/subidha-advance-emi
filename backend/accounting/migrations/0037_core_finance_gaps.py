    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('lease_expense_account', models.ForeignKey(blank=True, limit_choices_to={'account_type': 'EXPENSE'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='lease_expense_records', to='accounting.chartofaccount')),
                ('lease_liability_account', models.ForeignKey(blank=True, limit_choices_to={'account_type': 'LIABILITY'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='lease_liability_records', to='accounting.chartofaccount')),
                ('rou_asset_account', models.ForeignKey(blank=True, limit_choices_to={'account_type': 'ASSET'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rou_asset_leases', to='accounting.chartofaccount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('accumulated_depreciation_account', models.ForeignKey(limit_choices_to={'account_type': 'ASSET'}, on_delete=django.db.models.deletion.PROTECT, related_name='accumulated_depreciation', to='accounting.chartofaccount')),
                ('asset_account', models.ForeignKey(limit_choices_to={'account_type': 'ASSET'}, on_delete=django.db.models.deletion.PROTECT, related_name='fixed_assets', to='accounting.chartofaccount')),
                ('depreciation_expense_account', models.ForeignKey(limit_choices_to={'account_type': 'EXPENSE'}, on_delete=django.db.models.deletion.PROTECT, related_name='depreciation_expenses', to='accounting.chartofaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_index=True, default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('source_account', models.ForeignKey(limit_choices_to={'account_type': 'EXPENSE'}, on_delete=django.db.models.deletion.PROTECT, related_name='cost_allocation_rules', to='accounting.chartofaccount')),
            ],
            options={
