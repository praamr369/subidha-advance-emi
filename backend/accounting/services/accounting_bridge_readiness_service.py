...
EVENT_REGISTRY: tuple[BridgeEventSpec, ...] = (
    ...
    BridgeEventSpec(
        event_key="rent_monthly_revenue",
        label="Rent monthly revenue",
        source_module="subscriptions",
        source_app="subscriptions",
        source_model="RentLeaseBillingDemand",
        event_group="Rent/Lease revenue mappings",
        debit_requirements=("CUSTOMER_RECEIVABLE",),
        credit_requirements=("RENT_INCOME", "OUTPUT_GST only when tax exists"),
        debit_mapping_purposes=(FinanceAccountMappingPurpose.CUSTOMER_RECEIVABLE,),
        credit_mapping_purposes=(FinanceAccountMappingPurpose.RENT_INCOME,),
        operator_action="READY means mapping is ready; bridge journal posting remains pending until explicit admin posting.",
    ),
    BridgeEventSpec(
        event_key="lease_monthly_revenue",
        label="Lease monthly revenue",
        source_module="subscriptions",
        source_app="subscriptions",
        source_model="RentLeaseBillingDemand",
        event_group="Rent/Lease revenue mappings",
        debit_requirements=("CUSTOMER_RECEIVABLE",),
        credit_requirements=("LEASE_INCOME", "OUTPUT_GST only when tax exists"),
        debit_mapping_purposes=(FinanceAccountMappingPurpose.CUSTOMER_RECEIVABLE,),
        credit_mapping_purposes=(FinanceAccountMappingPurpose.LEASE_INCOME,),
        operator_action="READY means mapping is ready; bridge journal posting remains pending until explicit admin posting.",
    ),
    BridgeEventSpec(
