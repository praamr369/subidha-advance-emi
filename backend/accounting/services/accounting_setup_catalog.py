...
SYSTEM_POSTING_PROFILE_ACCOUNTS: tuple[CanonicalChartAccountSpec, ...] = (
    CanonicalChartAccountSpec(key="CUSTOMER_RECEIVABLE", code="AR-1000", name="Accounts Receivable", account_type=ChartOfAccountType.ASSET),
    CanonicalChartAccountSpec(key="CUSTOMER_ADVANCE_UNEARNED_REVENUE", code="ADV-2200", name="Customer Advances and Unapplied Receipts", account_type=ChartOfAccountType.LIABILITY),
    ...
    CanonicalChartAccountSpec(key="PURCHASE_EXPENSE", code="PUR-5000", name="Purchase Expense", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="SALES_REVENUE", code="REV-4000", name="Sales Revenue", account_type=ChartOfAccountType.INCOME),
    CanonicalChartAccountSpec(key="SALES_RETURNS", code="REV-4010", name="Sales Returns and Allowances", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="EMI_INCOME", code="EMI-4000", name="Advance EMI Collection Income", account_type=ChartOfAccountType.INCOME),
    CanonicalChartAccountSpec(key="EMI_COLLECTION_CLEARING", code="EMI-2100", name="EMI Collection Clearing", account_type=ChartOfAccountType.LIABILITY),
    CanonicalChartAccountSpec(key="EMI_WAIVER_RESERVE", code="EMI-2200", name="EMI Winner Waiver Reserve", account_type=ChartOfAccountType.LIABILITY),
    CanonicalChartAccountSpec(key="EMI_WAIVER_EXPENSE", code="EMI-5200", name="EMI Winner Waiver Expense", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="RENT_INCOME", code="RENT-4000", name="Rent Income", account_type=ChartOfAccountType.INCOME),
    CanonicalChartAccountSpec(key="LEASE_INCOME", code="LEASE-4000", name="Lease Income", account_type=ChartOfAccountType.INCOME),
    CanonicalChartAccountSpec(key="SECURITY_DEPOSIT_LIABILITY", code="SEC-2300", name="Rent/Lease Security Deposit Liability", account_type=ChartOfAccountType.LIABILITY),
    CanonicalChartAccountSpec(key="PARTNER_COMMISSION_PAYABLE", code="COM-2100", name="Partner Commission Payable", account_type=ChartOfAccountType.LIABILITY),
    CanonicalChartAccountSpec(key="PARTNER_COMMISSION_EXPENSE", code="COM-5100", name="Partner Commission Expense", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="DELIVERY_CHARGES_INCOME", code="DEL-4000", name="Delivery Charges Income", account_type=ChartOfAccountType.INCOME),
    CanonicalChartAccountSpec(key="DELIVERY_EXPENSE", code="DEL-5100", name="Delivery Expense", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="DAMAGE_RECOVERY", code="DMG-4000", name="Damage Recovery Income", account_type=ChartOfAccountType.INCOME),
    CanonicalChartAccountSpec(key="SALARY_PAYABLE", code="PAY-2100", name="Salary Payable", account_type=ChartOfAccountType.LIABILITY),
    ...
    CanonicalChartAccountSpec(key="DEPRECIATION_EXPENSE", code="DEP-5200", name="Depreciation Expense", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="ELECTRICITY_EXPENSE", code="ELEC-5300", name="Electricity & Utilities Expense", account_type=ChartOfAccountType.EXPENSE),
    CanonicalChartAccountSpec(key="RENT_EXPENSE", code="RENT-5310", name="Rent Expense", account_type=ChartOfAccountType.EXPENSE),
...
CANONICAL_CHART_ACCOUNT_BY_KEY: dict[str, CanonicalChartAccountSpec] = {spec.key: spec for spec in CANONICAL_CHART_ACCOUNTS}
CANONICAL_CHART_ACCOUNT_BY_CODE: dict[str, CanonicalChartAccountSpec] = {spec.code.upper(): spec for spec in CANONICAL_CHART_ACCOUNTS}
