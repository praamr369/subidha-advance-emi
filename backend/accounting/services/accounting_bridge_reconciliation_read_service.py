...
PHASE_F_SOURCE_SPECS: tuple[dict[str, Any], ...] = (
    {"phase": "F1", "domain": "Cash/receipt/payment", "source_model": "Payment", "event_keys": ("subscription_emi_payment", "advance_emi_collection"), "accounting_shape": "Dr FinanceAccount chart account, Cr Customer receivable / EMI income", "source_owner": "payments.Payment"},
    ...
    {"phase": "F10", "domain": "Commission/payout", "source_model": "Commission", "event_keys": ("commission_accrual", "partner_commission_accrual", "sales_commission_accrual"), "accounting_shape": "Dr commission expense, Cr commission payable", "source_owner": "commissions.Commission"},
    {"phase": "F11", "domain": "Commission/payout", "source_model": "CommissionPayoutBatch", "event_keys": ("commission_payout", "commission_settlement", "partner_commission_payout", "commission_payable_settlement"), "accounting_shape": "Dr commission payable, Cr concrete payout finance account", "source_owner": "commissions.CommissionPayoutBatch"},
    ...
    {"phase": "F14", "domain": "Rent/lease", "source_model": "RentLeaseBillingDemand", "event_keys": ("rent_monthly_revenue", "lease_monthly_revenue", "rent_invoice_revenue", "lease_invoice_revenue", "rent_lease_invoice_revenue"), "accounting_shape": "Dr customer receivable, Cr rent/lease income / output tax when applicable", "source_owner": "payments.RentLeaseBillingDemand"},
    {"phase": "F15B", "domain": "Rent/lease", "source_model": "RentLeaseCollection", "event_keys": ("rent_lease_collection_source_contract",), "accounting_shape": "Source contract only; F15C owns controlled settlement posting", "source_owner": "payments.RentLeaseCollection", "default_status": "DEFERRED"},
    {"phase": "F15C", "domain": "Rent/lease", "source_model": "RentLeaseCollection", "event_keys": ("rent_lease_collection_settlement", "rent_lease_monthly_collection"), "accounting_shape": "Dr concrete finance account, Cr customer receivable / settlement account", "source_owner": "payments.RentLeaseCollection"},
    {"phase": "F16", "domain": "Security deposit", "source_model": "RentLeaseDepositTransaction", "event_keys": ("security_deposit_source_contract",), "accounting_shape": "Source contract only; F17/F18 own receipt/refund posting", "source_owner": "payments.RentLeaseDepositTransaction", "default_status": "DEFERRED"},
    {"phase": "F17", "domain": "Security deposit", "source_model": "RentLeaseDepositTransaction", "event_keys": ("security_deposit_receipt", "rent_security_deposit_receipt", "lease_security_deposit_receipt"), "accounting_shape": "Dr concrete finance account, Cr security deposit liability", "source_owner": "payments.RentLeaseDepositTransaction"},
    {"phase": "F18", "domain": "Security deposit", "source_model": "RentLeaseDepositTransaction", "event_keys": ("security_deposit_refund", "rent_security_deposit_refund", "lease_security_deposit_refund"), "accounting_shape": "Dr security deposit liability, Cr concrete finance account", "source_owner": "payments.RentLeaseDepositTransaction"},
    {"phase": "F19", "domain": "Customer advance", "source_model": "CustomerAdvance", "event_keys": ("customer_advance_source_contract",), "accounting_shape": "Source-contract hardening only; F20 owns receipt posting", "source_owner": "payments.CustomerAdvance", "default_status": "DEFERRED"},
    {"phase": "F20", "domain": "Customer advance", "source_model": "CustomerAdvance", "event_keys": ("customer_advance_receipt", "customer_advance"), "accounting_shape": "Dr concrete finance account, Cr customer advance liability", "source_owner": "payments.CustomerAdvance"},
    {"phase": "F21", "domain": "Customer advance", "source_model": "CustomerAdvanceAllocation", "event_keys": ("customer_advance_application", "advance_application"), "accounting_shape": "Dr customer advance liability, Cr customer receivable", "source_owner": "payments.CustomerAdvanceAllocation"},
    {"phase": "F22", "domain": "Customer advance", "source_model": "CustomerAdvanceRefund", "event_keys": ("customer_advance_refund_source_contract",), "accounting_shape": "Source-contract hardening only; F23 owns refund posting", "source_owner": "payments.CustomerAdvanceRefund", "default_status": "DEFERRED"},
    {"phase": "F23", "domain": "Customer advance", "source_model": "CustomerAdvanceRefund", "event_keys": ("customer_advance_refund",), "accounting_shape": "Dr customer advance liability, Cr concrete finance account", "source_owner": "payments.CustomerAdvanceRefund"},
