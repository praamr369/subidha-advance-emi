...
from api.v1.views.admin_rent_lease_accounting_bridge import (
    ...
    AdminRentLeasePostingBridgeConfigView,
    AdminRentLeasePostingBridgeDisableView,
    AdminRentLeasePostingBridgeEnableView,
...
urlpatterns = [
    ...
    path("rent-lease/accounting-bridge/config/", AdminRentLeasePostingBridgeConfigView.as_view()),
    path("rent-lease/accounting-bridge/enable/", AdminRentLeasePostingBridgeEnableView.as_view()),
    path("rent-lease/accounting-bridge/disable/", AdminRentLeasePostingBridgeDisableView.as_view()),
