...
class ReversalCaseCreateSerializer(serializers.Serializer):
    ...
    source_id = serializers.IntegerField(required=True, min_value=1)
    ...
    amount_snapshot = serializers.DecimalField(required=False, max_digits=12, decimal_places=2, default="0.00")
    paid_amount_snapshot = serializers.DecimalField(required=False, max_digits=12, decimal_places=2, default="0.00")
    refundable_amount = serializers.DecimalField(required=False, max_digits=12, decimal_places=2, default="0.00")
    customer_credit_amount = serializers.DecimalField(required=False, max_digits=12, decimal_places=2, default="0.00")
