                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "SUPPORT_REQUEST_NOTE_UPDATED",
                                "Support Request Notes Updated",
                            ),
                            ...
                            (
                                "DRAW_CERTIFICATE_PUBLISHED",
                                "Draw Certificate Published",
                            ),
                            ("LUCKY_ID_BULK_ASSIGNED", "Lucky ID Bulk Assigned"),
                            ("LUCKY_ID_REASSIGNED", "Lucky ID Reassigned"),
                            (
                                "DRAW_PUBLIC_VERIFIED",
                                "Public Draw Verification Generated",
                            ),
                            (
                                "DRAW_PUBLIC_RESULT_PUBLISHED",
                                "Public Draw Result Published",
                            ),
                            ...
                            (
                                "PASSWORD_RESET_INVALIDATED",
                                "Password Reset Invalidated",
                            ),
                            ("CUSTOMER_CREATED", "Customer Created"),
                            (
                                "CUSTOMER_QUICK_CREATED",
                                "Customer Quick-Created (No Email)",
                            ),
                            ("CUSTOMER_EMAIL_ADDED", "Customer Email Added"),
                            ("CUSTOMER_EMAIL_CHANGED", "Customer Email Changed"),
                            (
                                "CUSTOMER_PHOTO_UPDATED",
                                "Customer Profile Photo Updated",
                            ),
                            (
                            ...
                            (
                                "CONTRACT_TERMS_LOCKED",
                                "Contract Financial Terms Locked",
                            ),
                            ...
                            (
                                "CONTRACT_RETURN_INSPECTION_CREATED",
                            ...
                            (
                                "CONTRACT_DOCUMENT_REGENERATED",
                                "Contract Document Regenerated",
                            ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "DIRECT_SALE_PAYMENT_RECEIVED",
                                "Direct Sale Payment Received",
                            ),
                            ("DRAW_SNAPSHOT_FROZEN", "Draw Snapshot Frozen"),
                            ("DRAW_COMMITTED", "Draw Committed"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="business_ev_event_t_ba4439_idx",
                    ),
                    models.Index(
                        fields=["customer", "occurred_at"],
                        name="business_ev_custome_ef06e3_idx",
                    ),
                    models.Index(
                        fields=["subscription", "occurred_at"],
                        name="business_ev_subscri_de7999_idx",
                    ),
                    models.Index(
                        fields=["payment", "occurred_at"],
                        name="business_ev_payment_8bb53b_idx",
                    ),
                    models.Index(
                        fields=["contract_reference", "occurred_at"],
                        name="business_ev_contrac_682257_idx",
                    ),
                    models.Index(
                        fields=["batch", "occurred_at"],
                        name="business_ev_batch_i_681eef_idx",
                    ),
                    models.Index(
                        fields=["lucky_id", "occurred_at"],
                        name="business_ev_lucky_i_249ce0_idx",
                    ),
                ],
            },
        ),
