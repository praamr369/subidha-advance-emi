...
BUSINESS_COMPLIANCE_TEMPLATES: tuple[BusinessComplianceTemplate, ...] = (
    ...
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload the approved template pack or legal sign-off memo when scaling to multi-party or partner contracts.",
        readiness_impact="Optional for a sole proprietorship. Upload only when formal contract templates are in active use.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload when operating a marketplace or multi-vendor platform. Not needed for a single-seller direct business.",
        readiness_impact="Optional for a sole proprietorship. Relevant when multi-vendor or marketplace flows are active.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload screenshots or release evidence when digital consent flows are live. Optional for offline/cash-based businesses.",
        readiness_impact="Optional for sole proprietors operating primarily in-person. Upload when digital onboarding flows are activated.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload when enabling eSign or digital contract execution. Not required for manual/paper-based signing.",
        readiness_impact="Optional for a sole proprietorship. Relevant when eSign/DSC execution is activated.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload evidence schema or SOP when electronic signatures are in production use.",
        readiness_impact="Optional for a sole proprietorship. Required only when eSign/clickwrap records must be legally auditable.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload eSign provider configuration evidence before enabling DSC/eSign in production.",
        readiness_impact="Optional for a sole proprietorship. Required only when CCA-grade electronic signatures are used.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload stamp-duty matrix or legal sign-off when executing high-value or notarisable agreements.",
        readiness_impact="Optional for day-to-day furniture sales. Upload when stamped agreements are in active use.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload tax SOP or invoice-role matrix when operating as an e-commerce operator (ECO) or marketplace. Not needed for a direct-seller sole prop.",
        readiness_impact="Optional for a sole proprietorship selling directly. Relevant when acting as an ECO or platform.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload grievance SOP when operating at scale or when required by the Consumer Protection (E-Commerce) Rules.",
        readiness_impact="Optional for a sole proprietorship with in-person customer service. Upload when e-commerce scale requires formal disclosure.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload partner agreement and compensation SOP when scaling a partner/agent network.",
        readiness_impact="Optional for a sole proprietorship. Required only when active partner or agent recruitment is underway.",
    ),
    BusinessComplianceTemplate(
        ...
        recommended_action="Upload privacy/KYC SOP when digital identity verification or Aadhaar-based e-KYC flows are activated.",
        readiness_impact="Optional for a sole proprietorship. Upload when KYC/identity verification is part of the customer onboarding flow.",
    ),
    BusinessComplianceTemplate(
...
def build_business_compliance_readiness() -> dict[str, Any]:
    ...
    # Recommended missing only counts truly missing RECOMMENDED items (not OPTIONAL)
