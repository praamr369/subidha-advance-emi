...
_ADDR = "South Dhadka Sukantapally, Near Rupkatha Cinema Hall, Dakhin Dhadka, Asansol, Paschim Barddhaman, West Bengal â€“ 713302"
_PHONE = "+91 94764 90946"
_EMAIL = "subidhafurnitureofficial@gmail.com"
_WEB = "www.subidhafurnitureasansol.com"
_BIZ = "Subidha Furniture"
_OWNER = "Pradip Roy"
...
- Contract and dispute records: 3â€“7 years from contract closure or dispute resolution
...
## 1. Direct Sale â€” Cancellation Before Delivery
...
## 2. Direct Sale â€” Return After Delivery
...
## 3. Lucky Plan EMI â€” Cancellation
...
- Reversal is processed subject to payment processor timelines (typically 3â€“7 working days after confirmation)
...
| Scenario | Timeline |
|---|---|
| Pre-delivery cancellation (approved) | 3â€“7 working days |
| Post-delivery return (approved) | 7â€“15 working days from product return confirmation |
| Payment reversal / technical error | 3â€“7 working days after confirmation |
| Security deposit refund (rent/lease closure) | 7â€“15 working days from closure sign-off |

## 7. How to Raise a Refund or Cancellation Request

- **Phone/WhatsApp:** {phone} (9 AMâ€“6 PM, Mondayâ€“Saturday)
- **Email:** {email}
- **In person:** {addr}
...
- **Structural defects** (frame, joints, core material): as stated per product, typically 1â€“2 years
- **Surface and finish defects** (fabric, paint, laminate): as stated per product, typically 6â€“12 months
...
- Email us at **{email}**
- Use the customer portal: Customer â†’ Support â†’ New Service Request
...
| Out-of-warranty repair â€” inspection/visit fee | As quoted |
| Out-of-warranty repair â€” parts + labour | As quoted |
...
- Service appointment acknowledgement: within 1â€“2 business days
- Technician visit: within 5â€“7 business days (sooner for urgent cases; subject to availability)
...
- Not attempt self-repair, disassembly, or third-party repair (for in-warranty products) â€” this voids the warranty
...
- **Cash** â€” accepted at our showroom; subject to cash limits under Income Tax Act 1961 s.269ST (no single transaction in cash exceeding â‚¹2,00,000)
- **UPI** â€” Google Pay, PhonePe, Paytm, BHIM UPI, and all UPI-enabled apps
- **Bank transfer (NEFT / RTGS / IMPS)** â€” to our registered business account
- **Debit/credit card** â€” via our card terminal at the showroom (where available)
- **Cheque** â€” accepted for select transactions; subject to clearance; receipt issued on clearance

Cash payments above â‚¹50,000 require the customer to furnish PAN as per Income Tax Act requirements.
...
All invoices are issued in compliance with the **Central Goods and Services Tax (CGST) Act, 2017**. GST rates applicable to furniture products are as per the current GST schedule. GSTIN of the customer (if applicable) must be provided before invoice generation â€” GST invoices cannot be amended after filing.
...
- The draw winner's remaining unpaid future EMIs in the current subscription are waived â€” this is the **EMI Waiver Benefit**
...
- Late payment may attract a late charge as specified in the contract (typically 1.5%â€“2% per month on the outstanding amount) and may result in service/support hold
...
- The security deposit balance (after all deductions) is refunded within 7â€“15 working days of closure sign-off
...
## 2. Step 1 â€” Direct Contact (First Resolution Attempt)

Contact us first. Most issues are resolved within 1â€“3 business days at this stage.

| Channel | Details |
|---|---|
| Phone/WhatsApp | **{phone}** (9 AMâ€“6 PM, Monâ€“Sat) |
| Email | **{email}** |
| In person | {addr} |
...
## 3. Step 2 â€” Escalation to Grievance Officer
...
## 4. Step 3 â€” External Escalation
...
Subidha Furniture [is registered / is not yet registered â€” update this section after GST registration] under the **Central Goods and Services Tax (CGST) Act, 2017**.
...
- GSTIN: **[YOUR GSTIN â€” update after registration]**

## 3. Income Tax Compliance

- All business income is reported under the Income Tax Act, 1961
- Cash transactions are limited to comply with s.269ST (no single cash transaction â‰¥ â‚¹2,00,000)
...
- Udyam Registration No.: **[YOUR UDYAM NO. â€” update after registration]**
...
- Udyam Registration Certificate (MSMED Act registration â€” see MSME Policy)
- GST Registration Certificate (GSTIN â€” see Business Compliance Policy)
...
| Field | Details |
|---|---|
| Udyam Registration Number | **[YOUR UDYAM REGISTRATION NO. â€” fill in after registration]** |
| Enterprise Category | Micro Enterprise |
| NIC Activity | Furniture retail and rental |
| Date of Registration | **[DATE â€” fill in after registration]** |
...
## 3. Delayed Payment Obligations (MSMED Act s.15â€“16)
...
- Delayed payments attract compound interest at 3Ã— the bank rate (RBI)
...
|---|---|---|
| Phone/WhatsApp | {phone} | 9 AMâ€“6 PM, Monâ€“Sat |
| Email | {email} | Responses within 1â€“2 business days |
...
5. Follow up within 3â€“5 business days if no response is received
...
""".format(phone=_PHONE, email=_EMAIL, addr=_ADDR, web=_WEB),
    ...
    # â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
        ...
        "category": "PRIVACY",
        "summary": "How customers exercise data access, correction, erasure, and nomination rights under DPDP 2023 ss.11â€“14.",
        "default_status": DEFAULT_POLICY_STATUS,
...
- **Email:** {email} (Subject: Data Request â€” [Access / Correction / Erasure / Grievance / Nomination])
- **Phone/WhatsApp:** {phone}
- **In person:** {addr}
...
|---|---|---|
| **Essential / Strictly Necessary** | Required for login, session management, security, and shopping cart functions | No â€” essential for the website to work |
...
- **Accept all cookies** â€” enable all categories above
- **Accept essential only** â€” only strictly necessary cookies are set
- **Manage preferences** â€” individually toggle each category
...
- **PAN Card** (required for cash transactions â‰¥ â‚¹50,000 and for Lucky Plan/rent/lease contracts)
...
We send the following communications in the course of our business relationship with you â€” these are necessary for contract performance and do not require separate consent:
...
## 2. Overdue EMI â€” Stage 1: Reminder

**Days 1â€“7 after due date (within grace period or immediately after):**
...
## 3. Overdue EMI â€” Stage 2: Draw Eligibility Suspension
...
## 4. Overdue EMI â€” Stage 3: Subscription Review
...
## 5. Overdue EMI â€” Stage 4: Default and Repossession
...
- The customer portal (visible to all batch participants â€” Lucky ID only, not personal name)
...
- **Timeline:** Within **7â€“15 working days** after:
...
- **Information Technology Act, 2000 (IT Act)** â€” recognises electronic records and electronic signatures as legally valid
- **Indian Contract Act, 1872** â€” contracts may be formed electronically
- **Evidence Act, 1872** (as amended) â€” electronic records are admissible as evidence
...
- You may decline digital signing and request a physical paper contract â€” contact us to arrange this
...
**Internal Governance Policy â€” Not Customer-Facing**
...
|---|---|
| Up to â‚¹5,000 | Senior cashier or finance officer |
| â‚¹5,001 â€“ â‚¹25,000 | Finance manager or admin |
| Above â‚¹25,000 | Business owner (Pradip Roy) or designated authority |
...
The cashier who collected the payment must not independently close a major reconciliation exception. Mismatches above â‚¹5,000 require Finance Manager or admin review before closure.

## 6. Period Close Control

Accounting period close or day-close must not be signed off with material unresolved reconciliation items. "Material" is defined as any single item above â‚¹500 or total unreconciled items above â‚¹2,000.
...
- Escalated to the Finance Manager if the mismatch is above â‚¹500
...
|---|---|
| 1000â€“1999 | Assets |
| 2000â€“2999 | Liabilities |
| 3000â€“3999 | Capital / Equity |
| 4000â€“4999 | Revenue |
| 5000â€“5999 | Cost of Goods Sold |
| 6000â€“6999 | Operating Expenses |
| 7000â€“7999 | Other Income |
| 8000â€“8999 | Other Expenses / Provisions |
...
| Inventory â€” Furniture | 1201 | Asset |
...
- Direct sale â€” on confirmed invoice and payment received
- Lucky Plan subscription â€” on first EMI payment confirmed and subscription activated
- Rent/lease contract â€” on security deposit and first month's rent confirmed
...
- PO must be approved by the Finance Manager or business owner for amounts above â‚¹10,000
...
- Three-way match: PO quantity Ã— PO price = GRN quantity Ã— Invoice amount (within tolerance)
...
- Payment requires Finance Manager or business owner approval for amounts above â‚¹10,000
...
|---|---|
| Up to â‚¹2,000 | Store manager |
| â‚¹2,001 â€“ â‚¹10,000 | Finance Manager |
| Above â‚¹10,000 | Business owner (Pradip Roy) |
...
- Amendments affecting payment amounts above â‚¹1,000 per month require Finance Manager or business owner approval
...
- Any suspected compromise must be reported immediately to the admin â€” password is reset within 2 hours
...
- Timestamp (UTC, system-generated â€” not user-editable)
...
**Step 1 â€” Contain (within 6 hours):**
...
**Step 2 â€” Assess (within 24 hours):**
...
**Step 3 â€” Notify (within 72 hours for HIGH/CRITICAL):**
...
**Step 5 â€” Review (within 30 days):**
...
def get_default_policy_templates() -> list[dict]:
    """Return all 39 policy templates. Self-contained â€” no external merge."""
    from copy import deepcopy
